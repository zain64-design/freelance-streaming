                                ...
                                <div class="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-10 col-xxl-10">
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                            <div class="layoutbox">
                                                <img src="images/layout-1.png" class="img-fluid" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                            <div class="layoutbox">
                                                <img src="images/layout-2.png" class="img-fluid" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                            <div class="layoutbox">
                                                <img src="images/layout-3.png" class="img-fluid" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                            <div class="layoutbox">
                                                <img src="images/layout-4.png" class="img-fluid" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                            <div class="layoutbox">
                                                <img src="images/layout-5.png" class="img-fluid" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                            <div class="layoutbox">
                                                <img src="images/layout-6.png" class="img-fluid" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                            <div class="layoutbox">
                                                <img src="images/layout-7.png" class="img-fluid" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                            <div class="layoutbox">
                                                <img src="images/layout-8.png" class="img-fluid" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                            <div class="layoutbox">
                                                <img src="images/layout-9.png" class="img-fluid" alt="img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
