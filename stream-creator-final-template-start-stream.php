            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6 bordr-right">
                                <div class="startform">
                                    <i class="fa-regular fa-video"></i>
                                    <h3>Start now</h3>
                                    <p>Start your online stream immediately</p>
                                    <a href="#">Start Now</a>
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                <div class="startform">
                                    ...
                                    <h3>Schedule</h3>
                                    <form>
                                        <div class="form-group scheudulegroup mb-3">
                                            <input type="text" placeholder="02/06/2024" class="form-control date">
                                            <input type="text" placeholder="05:00 p.m" class="form-control time">
                                        </div>
                                    </form>
                                    <p>Schedule your stream for any date on your calendar</p>
